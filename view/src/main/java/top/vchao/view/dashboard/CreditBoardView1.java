 ...
 */
public class CreditBoardView1 extends View {
    ...
    public CreditBoardView1(Context context) {
        this(context, null);
    }

    public CreditBoardView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CreditBoardView1(Context context, AttributeSet attrs, int defStyleAttr) {
