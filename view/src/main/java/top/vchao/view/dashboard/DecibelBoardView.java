...
/**
 * @ description: 分贝仪仪表盘
 * @ author: xiao_nian  @ blog: https://blog.csdn.net/xiao_nian/article/details/83141422
 * @ update: vchao  @ blog: https://vchao.blog.csdn.net/
 */
public class DecibelBoardView extends View {
    private int maxDb;
    static int minDb;
    ...
    public DecibelBoardView(Context context) {
        this(context, null);
    }

    public DecibelBoardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public DecibelBoardView(Context context, AttributeSet attributeSet, int i) {
    ...
    private void obtainStyledAttributes(Context context, AttributeSet attributeSet, int i) {
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.DecibelBoardView, i, 0);
            this.outsideRoundRadius = obtainStyledAttributes.getDimension(R.styleable.DecibelBoardView_outsideRoundRadius, 402.0f);
            this.colorRoundRadius = obtainStyledAttributes.getDimension(R.styleable.DecibelBoardView_colorRoundRadius, 325.0f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 绘制描述分贝的文字
        this.currentValuePaint.setStyle(Paint.Style.FILL);
        this.dbTextPaint.setStyle(Paint.Style.FILL);
