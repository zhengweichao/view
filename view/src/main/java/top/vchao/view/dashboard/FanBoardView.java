 ...
 */
public class FanBoardView extends View {
    ...
    public FanBoardView(Context context) {
        this(context, null);
    }

    public FanBoardView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FanBoardView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.parseColor("#00b4aa"));
