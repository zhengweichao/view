...
public class CreditBoardView2 extends View {
    ...
    public CreditBoardView2(Context context) {
        this(context, null);
    }

    public CreditBoardView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CreditBoardView2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mBgColors = new int[]{Color.parseColor("#FF5722"),
                Color.parseColor("#FF9800"),
                Color.parseColor("#FFC107"),
                Color.parseColor("#3FB830"),
                Color.parseColor("#00BAED")};
    }
